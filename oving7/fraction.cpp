...
Fraction Fraction::operator-(int integer) const { // oppg1 a)
  Fraction fraction;
  fraction.set(integer);
  return *this - fraction;
}

Fraction operator-(int integer, const Fraction &other) { // oppg1 a)
  Fraction fraction;
  fraction.set(integer);
  return fraction - other;
}

ostream &operator<<(ostream &out, const Fraction &fraction) { // extra
